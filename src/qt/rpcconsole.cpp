                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzPAPathCustom = GetArg("-zpabackuppath", "");
    ...
    if(!strzPAPathCustom.empty()) {
        ui->wallet_customzpabackuppath->setText(QString::fromStdString(strzPAPathCustom));
        ui->wallet_customzpabackuppath_label->setVisible(true);
        ui->wallet_customzpabackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzPAPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Polar RPC console.") + "<br>" +
