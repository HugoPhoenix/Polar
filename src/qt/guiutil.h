...
/** Utility functions used by the Polar Qt UI.
 */
namespace GUIUtil
{
...
// Render Polar addresses in monospace font
...
// Parse "polar:" URI into recipient object, return true on successful parsing
