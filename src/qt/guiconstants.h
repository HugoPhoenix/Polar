...
/* Polar GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Polar"
#define QAPP_ORG_DOMAIN "polar.org"
#define QAPP_APP_NAME_DEFAULT "Polar-Qt"
#define QAPP_APP_NAME_TESTNET "Polar-Qt-testnet"
