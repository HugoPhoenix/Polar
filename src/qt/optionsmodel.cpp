...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::PA);
...
// Wallet
    ...
    if (settings.contains("nAnonymizePolarAmount"))
        SoftSetArg("-anonymizepolaramount", settings.value("nAnonymizePolarAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in polar.cpp during shotdown to also remove the window positions
