...
static Checkpoints::MapCheckpoints mapCheckpoints = {
    ...
    {25000, uint256("000000005bcb92b43bf576073b763c2eb05319fc14444a6680358a42e5520f02")},
    {350000, uint256("00000004cb2c553828646b2a356f046b32bfa83550064422be29edb96ef05eba")},
    {358800, uint256("00000002fc698f065c45d17af3aedb4d541c0bd4892da55e5f51e6531dd587e0")},
    };
...
public:
    CMainParams()
    {
        ...
        nEnforceNewSporkKey = 1615554015;
         ...
         *     CTxIn(COutPoint(000000, -1), coinbase )
         *     CTxOut(nValue=50.00000000, scriptPubKey=0xA9037BAC7050C479B121CF)
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "12032021";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 190 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0480aedbe78d1e1beaed4666517375def89c3baea39f6ab8e609852d7451c7702863a4f0ebd40745525d550694fa0d651ce2230ef61ce5c8dc25cd23e2dd4e6d3e") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1615554015;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 21423841;
        ...
        strSporkKey = "04ab8eb7ae8196be56995cf9a85f85c3594257c9b62ec6eba8c1439d0ac59493bc2aaf0edebc8fe483766a252630f9a91d20098d765d16ce3db49a4eda16d3c4de";
        strSporkKeyOld = "04B433E6598390C992F4F022F20D3B4CBBE691652EE7C48243B81701CBDB7CC7D7BF0EE09E154E6FCBF2043D65AF4E9E97B89B5DBAF830D83B9B7F469A6C45A717";
        strObfuscationPoolDummyAddress = "PAB2VEnMm72LF2CB4DYGHH7HHinUcLWsJ2";
        nStartMasternodePayments = 1615554015;
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zpa to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("04d92e931ec0ecdf60b939bd18da8c7e18c9f3a01f0244adfad3ce6ebb345e8f5149f2535d2c5d2a0f1e091692023e2dc9858516d65137f25a17198a0d223cd48b");
        nDefaultPort = 41046;
        nEnforceBlockUpgradeMajority = 0;
        nRejectBlockOutdatedMajority = 0;
        nToCheckBlockUpgradeMajority = 0;
        ...
        // Testnet polar BIP44 coin type is '1' (All coin's testnet default)
        ...
        strSporkKey = "047e40ee0b67fa0162f98ea5ae990cdba02e90d38fe2ce99aa5ac2062a208999dc9c250ee2995cee19607945860357896d84b066f895cb9c8dcd9f06be71b72ab3";
        strSporkKeyOld = "04348C2F50F90267E64FACC65BFDC9D0EB147D090872FB97ABAE92E9A36E6CA60983E28E741F8E7277B11A7479B626AC115BA31463AC48178A5075C5A9319D4A38";
        strObfuscationPoolDummyAddress = "AaXEonJM5kAAJBGpSUthfvoSGjRmTvkwvs";
        nStartMasternodePayments = 1615554015;
...
public:
    CRegTestParams()
    {
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000008eb30d07018d5f4d346d9926e7021704a0d8da6bb186a8b101f83f3f16b"));
        //assert(hashGenesisBlock == uint256("0x7de3c9b97c472dd0ef5ad676b2e16ab7aadd4bef211467c14e217520f2c934b7"));
