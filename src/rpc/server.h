...
extern UniValue DoZpaSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzpaseed(const UniValue& params, bool fHelp);
extern UniValue getzpaseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzpa(const UniValue& params, bool fHelp);
extern UniValue dzpastate(const UniValue& params, bool fHelp);
