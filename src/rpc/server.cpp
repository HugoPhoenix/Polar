...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Polar features */
        {"polar", "listmasternodes", &listmasternodes, true, true, false},
        {"polar", "getmasternodecount", &getmasternodecount, true, true, false},
        {"polar", "masternodeconnect", &masternodeconnect, true, true, false},
        {"polar", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"polar", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"polar", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"polar", "masternodecurrent", &masternodecurrent, true, true, false},
        {"polar", "masternodedebug", &masternodedebug, true, true, false},
        {"polar", "startmasternode", &startmasternode, true, true, false},
        {"polar", "createmasternodekey", &createmasternodekey, true, true, false},
        {"polar", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"polar", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"polar", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"polar", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"polar", "getmasternodescores", &getmasternodescores, true, true, false},
        {"polar", "preparebudget", &preparebudget, true, true, false},
        {"polar", "submitbudget", &submitbudget, true, true, false},
        {"polar", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"polar", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"polar", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"polar", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"polar", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"polar", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"polar", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"polar", "checkbudgets", &checkbudgets, true, true, false},
        {"polar", "mnsync", &mnsync, true, true, false},
        {"polar", "spork", &spork, true, true, false},
        {"polar", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzpaseed", &getzpaseed, false, false, true},
        {"zerocoin", "setzpaseed", &setzpaseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzpa", &searchdzpa, false, false, true},
        {"zerocoin", "dzpastate", &dzpastate, false, false, true},
...
{
    return "> polar-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:31045/\n";
}
