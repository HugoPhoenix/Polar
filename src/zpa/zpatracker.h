...
#ifndef Polar_ZPATRACKER_H
#define Polar_ZPATRACKER_H
...
public:
    CzPATracker(std::string strWalletFile);
    ~CzPATracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzPAWallet* zPAWallet = NULL);
