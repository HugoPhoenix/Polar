...
#ifndef Polar_ZPAWALLET_H
#define Polar_ZPAWALLET_H
...
public:
    CzPAWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZPA(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZPA(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
