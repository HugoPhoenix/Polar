Contributing to Polar Core
============================

The Polar Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/polar-project/polar/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Polar Core project, and is not to be
confused with overall Polar Network Protocol consensus changes.

Whether a pull request is merged into Polar Core rests with the project merge
...
Patches that change Polar consensus rules are considerably more involved than
...
Where a patchset proposes to change the Polar consensus, it must have been
...
The project leader is the release manager for each Polar Core release.
