...
This issue tracker is only for technical issues related to Polar Core.
General Polar questions and/or support requests and are best directed to the [Polar Discord](https://discord.polar.org).
...
### What version of Polar Core are you using?
