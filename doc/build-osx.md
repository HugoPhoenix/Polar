...
1. Clone the Polar Core source code:

        git clone https://github.com/polar-project/polar
        cd polar
...
Polar Core is now available at `./src/polard`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/Polar"

    touch "/Users/${USER}/Library/Application Support/Polar/polar.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Polar/polar.conf"

The first time you run polard, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/Polar/debug.log

Other commands:
-------

    ./src/polard -daemon # Starts the polar daemon.
    ./src/polar-cli --help # Outputs a list of command-line options.
    ./src/polar-cli help # Outputs a list of RPC commands when the daemon is running.
