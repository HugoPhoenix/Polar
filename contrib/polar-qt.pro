...
RESOURCES += src/qt/polar.qrc src/qt/polar_locale.qrc

TRANSLATIONS += src/qt/locale/polar_bg.ts \
                src/qt/locale/polar_de.ts \
                src/qt/locale/polar_en.ts \
                src/qt/locale/polar_es.ts \
                src/qt/locale/polar_fi.ts \
                src/qt/locale/polar_fr.ts \
                src/qt/locale/polar_it.ts \
                src/qt/locale/polar_ja.ts \
                src/qt/locale/polar_pl.ts \
                src/qt/locale/polar_pt.ts \
                src/qt/locale/polar_ru.ts \
                src/qt/locale/polar_sk.ts \
                src/qt/locale/polar_sv.ts \
                src/qt/locale/polar_vi.ts \
                src/qt/locale/polar_zh_CN.ts \
                src/qt/locale/polar_zh_TW.ts
