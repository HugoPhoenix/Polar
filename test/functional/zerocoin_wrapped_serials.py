...
from fake_stake.base_test import Polar_FakeStakeTest

class zPAwrappedSerialsTest(Polar_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zPAs..." % DENOM_TO_USE)
